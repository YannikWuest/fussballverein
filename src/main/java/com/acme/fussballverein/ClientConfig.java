...
import com.acme.fussballverein.repository.MitgliedRestRepository;
...
public interface ClientConfig {
    ...
    default UriComponentsBuilder uriComponentsBuilder() {
        final var kundeHostEnv = System.getenv("MITGLIED_SERVICE_HOST");
        ...
        final var kundePortEnv = System.getenv("MITGLIED_SERVICE_PORT");
        final int kundePort;
    ...
    @Bean
    default MitgliedRestRepository kundeRestRepository(final WebClient builder) {
